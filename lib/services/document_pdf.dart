...
/// Opens the platform print/share sheet, from which the PDF can be saved
/// or sent. Works the same on macOS, Android and web.
Future<void> printDocument(DocumentView doc) async {
  final bytes = await buildDocumentPdf(doc);
  await Printing.layoutPdf(
    onLayout: (_) async => bytes,
    name: '${doc.docType} ${doc.docNo}'.replaceAll(' ', '-'),
  );
}
